...
//
//public class TempReservation extends JFrame {
//
...
//        ActionListener add = new addUpgradeListener();
//        roomUpgrade.addActionListener(particularRoomUpgradeListener);
//        particularRoomUpgrades.addActionListener(add);
//        //particularRoomUpgrades = new JComboBox(selectAlert);
//        ActionListener saveUpgradeListener = new addUpgradeListener();
...
//    }
//
//    class addUpgradeListener implements ActionListener{
//        @Override
//        public void actionPerformed(ActionEvent click){
//            particularRoomUpgrades = (JComboBox) click.getSource();
//            String particularUpgrade = (String) particularRoomUpgrades.getSelectedItem();
//            if (aRoomUpgrade == "Towels Rental") {
